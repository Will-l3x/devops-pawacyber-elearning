        ...
        <main id="main">
          <div className="wrapper">
            ...
            <div id="section">
              ...
              <section id="content" style={{ paddingTop: 90 }}>
                <div className="row">
                  ...
                  <div className="col m7 s12">
                    <div className="col s12">
                      <p style={{ fontSize: 14 }}>
                        ...
                        learners to the school who must also register.
                      </p>
                      <p style={{ fontSize: 14 }}>
                        The affiliate will be paid a commission of 10 percent
                        (10%) exclusive of VAT, of the subscription fee monthly.
                      ...
                      <div className="wallet-container">
                        <div className="wallet-content">
                          <div className="wallet-card">
                            <div className="wallet-upper-row">
                              <div className="wallet-card-item">
                                <span>My Balance</span>
                                <span>&nbsp;0</span>
                                <span className="dollar">N$</span>
                              </div>
                              <div className="wallet-card-item">
                            ...
                            <div className="wallet-transaction">
                              ...
                              <div className="wallet-details">
                                <div className="wallet-title">
                                  Pawa Cyber Online Schools
                                </div>
                                <div className="wallet-time">03.45PM</div>
                              </div>
                      ...
                      <div className="legal__terms-scroll">
                        <div id="terms-and-conditions">
                          ...
                          <p>
                            ...
                            visiting our site and / or purchasing something from
                            us, you engage in our “Service” and agree to be
                          ...
                          <p>
                            ...
                            Service. Any new features or tools which are added
                            to the current online school shall also be subject
                            to the Terms of Service. You can review the most
                            current version of the Terms of Service at any time
                            on this page. We reserve the right to update, change
                          ...
                          <p>
                            ...
                            networks. You agree not to reproduce, duplicate,
                            copy, sell, resell or exploit any portion of the
                          ...
                          <p>
                            Affiliate marketing on this website shall mean; a
                            way for Pawa Cyber School E-Learning to sell or
                            market its products by signing up individuals
                            ("affiliates") who market the school's products for
                            a commission. In this case, Pawa Cyber School shall
                            use graduate teachers to participate in affiliate
                            marketing by registering to the website first and in
                            turn they make referrals of learners to the school
                            who must also register. The affiliate will be paid a
                            commission of 10 percent (10%) exclusive of VAT, of
                            the subscription fee monthly. However, take note
                            this commission ceases to exist as soon as the
                            learner subscription expires. The affiliate will
                            only be paid commission if the learner is still
                            subscribed to the platform. For example, if the
                            affiliate brings a Junior Primary learner, the
                          ...
                          <p>
                            Any person or entity that participates or attempts
                            to participate in our marketing program must accept
                            this Agreement without change.
                          </p>
                          <p>
                            This Privacy Policy of Pawa Cyber School E-Learning
                            about Affiliate Marketing describes how we may
                            collect and use personal data and the rights to
                            affiliates regarding their respective data. By
                            joining the Affiliate marketing, you signify your
                            approval of the terms set out in this Privacy
                            Policy, and other terms and conditions. If you do
                            not agree to this Privacy Policy, you must not use
                            the affiliate marketing. We may update this Privacy
                            Policy from time to time in order to reflect, for
                            example, changes to our privacy practices or for
                            other operational, legal, or regulatory reasons. By
                            continuing to our affiliate program after these
                            changes are posted, you agree to the revised policy.
                          </p>
                          <h6>Personal Information Controller</h6>
                          <p>
                            Any personal information provided to or gathered by
                            Pawa Cyber School E-Learning under this Privacy
                            Notice will be stored and controlled by the school.
                          </p>
                          ...
                          <p>
                            ...
                            contact you, provide customer support when you
                            contact us, provide you with advertising and
                          ...
                          <p>
                            ...
                            our Return Policy. We have made every effort to
                            display as accurately as possible the colours and
                            images of our products that appear at the online
                            school. We cannot guarantee that your computer
                    ...
                    <div className="legal__actions">
                      ...
                      <div style={{ float: "right" }}>
                        ...
                        <button
                          ...
                          className="btn btn-success green accent-3 modal-close disabled"
                        >
                          Agree
                        </button>
                      </div>

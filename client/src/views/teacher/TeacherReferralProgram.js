...
class TeacherReferralProgram extends Component {
  constructor() {
    super();
    this.state = {
      user:
              ...
              <div className="container">
                <div className="row">
                  <div className="col s12">
                    <div className="ex-basic-1">
                      <h5 className="text-shadow-2">
                        Referral Program - Earn N$ 10 each.
                      </h5>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  ...
                  <div className="col m7 s12">
                    <div className="col s12">
                      <p style={{ fontSize: 14 }}>
                        We have doubled the amount you and your friend or family
                        member earn when they join Pawa Cyber School. It’s
                        simple: you spread the word about Pawa Cyber School
                        using your personal referral link via social media
                        channels, email, forums and websites. Your contacts
                        register with us. You both get a N$ 10 thank you from
                        us.
                      </p>
                      <p style={{ fontSize: 14, marginTop: 15 }}>
                        Remember, you can earn up to N$ 1,000 with Pawa Cyber
                        School’s Referral program!
                      </p>
                    </div>
                        ...
                        <div className="legal__terms">
                          <div className="legal__terms-scroll">
                            <div id="terms-and-conditions">
                              ...
                              <p>
                                This website is operated by Pawa Cyber School
                                cc. Throughout the site, the terms “we”, “us”
                                and “our” refer to Pawa Cyber School offers this
                              ...
                              <p>
                                ...
                                and policies referenced herein and / or
                              ...
                              <p>
                                ...
                                current online school shall also be subject to
                                the Terms of Service. You can review the most
                              ...
                              <p>
                                ...
                                for any reason at any time. You understand that
                                your content (not including credit card
                                information), may be transferred unencrypted and
                                involve (a) transmissions over various networks;
                                and (b) changes to conform and adapt to
                              ...
                              <p>
                                ...
                                Service you must make, and we must receive,
                                payment of your Fees in advance on or before the
                                Monthly Due Date. If we do not receive payment
                                of on or before due date, we will suspend your
                                access to the Service. If your access to the
                                Service is suspended, we will not reactivate
                                your access to the Service until we have
                                received payment of your Fees.
                              </p>
                              <h6>Modifications to the Service and Prices</h6>
                              <p>
                                Prices for our products and services are subject
                                to change without notice. We reserve the right
                                at any time to modify or discontinue the Service
                              ...
                              <p>
                                ...
                                accurately as possible the colours and images of
                                our products that appear at the online school.
                                We cannot guarantee that your computer monitor’s
                              ...
                              <p>
                                ...
                                basis. We reserve the right to limit the
                                quantities of any products or services that we
                                offer.
                              </p>
                              <p>
                                All descriptions of products or product pricing
                                are subject to change at any time without
                                notice, at the sole discretion of us. We reserve
                                the right to discontinue any product at any
                              ...
                              <p>
                                ...
                                your expectations, or that any errors in the
                              ...
                              <p>
                                ...
                                agree that Pawa Cyber School shall not be
                              ...
                              <p>
                                ...
                                that, in our sole judgment, appear to be placed
                                by dealers, resellers or distributors. You agree
                                to provide current, complete and accurate
                                purchase and account information for all
                                purchases made at our online school. You agree
                                to promptly update your account and other
                                information, including your email address and
                                credit card numbers and expiration dates, so
                              ...
                              <p>
                                ...
                                clarify information in the Service, Product or
                              ...
                              <p>
                                ...
                                decides to cancel, no refunds will be made. You
                                will be asked to acknowledge this policy during
                                the enrolment or registration process;
                                exceptions to this policy are not offered.
                              </p>
                              <h6>Entire Agreement</h6>
                              <p>
                                These Terms constitute the entire agreement
                                between Pawa Cyber School and you in relation to
                              ...
                              <p>
                                ...
                                Namibia, and you submit to the non-exclusive
                                jurisdiction of the state and federal courts
                                located in Namibia for the resolution of any
                                disputes.
                              </p>
                            </div>
                            <div id="privacy-notice">
                              ...
                              <p>
                                ...
                                "Site"). This page informs you of our policies
                              ...
                              <p>
                                ...
                                providing and improving the Site. By using the
                              ...
                              <p>
                                ...
                                the Pawa Cyber School Privacy Policy. If you do
                                not agree with this Privacy Policy, you may not
                                use our services. Your continued use of the
                                services following the posting.
                              </p>
                              <h6>Private Data We Receive And Collect</h6>
                              <p>
                                Pawa Cyber School also automatically collects
                                and receives certain information from your
                                computer or mobile device, including the
                                activities you perform on our Website, the
                                Platforms, and the Applications, the type of
                                hardware and software you are using (for
                                ...
                                web page(s) you access (as applicable).
                              </p>

                              <p>
                                When you first register for a Pawa Cyber School
                                eLearning account, and when you use the
                              ...
                              <ol>
                                ...
                                <li>
                                  ...
                                  information to complete any financial
                                  transaction, and when making purchases through
                                  the Services, we may also collect your credit
                                  card or PayPal information
                                </li>
                                <li>
                                  Images or other files that you may publish via
                                  our Services
                                </li>
                                <li>
                                  Information (such as messages, posts,
                                  comments, pages, profiles, images) we may
                                  receive relating to communications you send
                                  us, such as queries or comments concerning.
                                </li>
                              </ol>
                              ...
                              <p>
                                ...
                                industry. They are used on most commercial and
                                other websites. Cookies are small text written
                                to your computer. They make our Website easier
                                for you to use because they save your
                                preferences while you’re at our sites (although
                                we do not save passwords in cookies). Cookies
                                also help us know which areas are your
                                favourites, which may need improvement and what
                                technologies and Internet services our Users
                                like. Knowing this information helps us improve
                                the services for our Users.
                              </p>
                              <p>
                                The information we track with cookies is
                                anonymous and is not used to identify, or lead
                                us back to, any particular User. Users may have
                                the option of disabling cookies via their
                                browser preferences (most browsers are initially
                                set up to accept cookies). However, some
                                features of our Website will not function
                                properly or may function more slowly if you
                                refuse cookies. While using our Website, you may
                                get cookies from our advertisers or sponsors. We
                                do not control such cookies. However, such use
                                of cookies is very common in the Internet
                                industry.
                              </p>
                              <h6>General Compliance With Laws</h6>
                              <p>
                                The safety of children is our highest priority.
                                We comply with applicable laws and regulations.
                                We will only use information collected for
                                educational purposes as it relates to our
                              ...
                              <ol>
                                <li>
                                  ...
                                  consent which will include an opportunity for
                                  the parent to prevent use of the information
                                  and the child’s participation in the related
                                  activity. Without prior parental consent,
                                  online information will only be used to
                                  respond directly to a child’s request and will
                                  not be used for other purposes.{" "}
                                </li>
                                <li>
                                  Use any information collected from students
                              ...
                              <p>
                                ...
                                priority. We exercise great care in providing
                                secure transmission of your information from
                                your PC to our servers. Unfortunately, no data
                                transmission over the Internet can be guaranteed
                                to be 100% secure. As a result, while we strive
                                ...
                                services, and you do so at your own risk. Once
                                we receive your transmission, we make our best
                                effort to ensure its security on our systems.
                              </p>
                              <p>
                                Whenever credit card information is transmitted
                                we use industry standard, SSL (secure socket
                                layer) encryption. If you have an account or use
                                another passwordprotected service, you are the
                                only person who can access it and view the User
                                information concerning the account. We strongly
                                recommend that you do not share your password
                                with anyone. We will never ask you for your
                                password in an unsolicited phone call or email.
                              </p>
                              <p>
                                Ultimately, you are responsible for maintaining
                                the secrecy of your passwords and any account
                                information. Please remember to sign out
                                properly and close your browser window when you
                                have finished your work. This helps ensure that
                                others cannot access your personal information
                                and in the event the computer you use is
                                accessible to others or if you share a computer
                                with someone else or use a computer in a public
                                place such as a library or Internet cafe.{" "}
                              </p>
                              <p>
                                In addition, from time to time we may create and
                                supply, at our sole discretion, additional
                                security features for our Users. These security
                                features are designed only for the use of Users.
                                We provide no warranty, express or implied that
                                any such security features may not be broken,
                              ...
                              <p>
                                ...
                                changes in its provisions in the future, which
                                will be in effect immediately after being posted
                                on this page.
                              </p>
                              <p>
                                We reserve the right to update or change our
                                Privacy Policy at any time and you should check
                                this Privacy Policy periodically. Your continued
                                use of the Service after we post any
                                modifications to the Privacy Policy on this page
                                will constitute your acknowledgment of the
                                modifications and your consent to abide and be
                                bound by the modified Privacy Policy.
                              </p>
                              <p>
                                If we make any material changes to this Privacy
                                Policy, we will notify you either through the
                                email address you have provided us, or by

...
import PackageOptions from "../components/student-components/PackageOption";
import SubcribeClassOptions from "../components/student-components/SubcribeClassOptions";
...
class RegisterPremiumTeacher extends Component {
  ...
  handleSubmit = (event) => {
    ...
    // } else {
    //   var registerAdmin = {
    //     id_num: event.target.id_num.value,
  ...
  handlePayment = (event) => {
    ...
    // var det = JSON.parse(localStorage.getItem("teacherPremiumRegData"));
  ...
  getClass() {
    var gradeStore = JSON.parse(localStorage.getItem("teacherPremiumRegData"));
    var data = {
      gradeid: "1",
  ...
  onSelectClassOption = (selectedOption) => {
    ...
    if (this.state.selectedsubs.length === this.state.numberOfsubs) {
      ...
      if (
        this.state.selectedsubs.includes({
          classname: "Maths",
          classId: (1 + this.state.selectedsubs.length).toString(),
        })
      ) {
        this.setState({
        ...
        var valSubs = this.state.selectedsubs.concat({
          classname: "Maths",
          classId: (1 + this.state.selectedsubs.length).toString(),
        });
        this.setState({
                ...
                <div className="col s12 m7">
                  {!this.state.proceedToPay ? (
                                ...
                                <div className="col s12">
                                  <div className="titles">
                                    ...
                                    <h2 className="subtitle">
                                      To create an account with Pawa Cyber,
                                  ...
                                  <div className="legal">
                                    <div className="legal__instructions">
                                      ...
                                      >
                                        ...
                                        <span>
                                          In order to continue, you must read
                                          the Terms & Conditions and Privacy
                                          Notice by scrolling to the bottom.
                                        </span>
                                      </div>
                                    </div>
                                    <div
                                    ...
                                    <div className="legal__terms">
                                      <div className="legal__terms-scroll">
                                        <div id="terms-and-conditions">
                                          ...
                                          <p>
                                            This website is operated by Pawa
                                            Cyber School cc. Throughout the
                                            site, the terms “we”, “us” and “our”
                                            refer to Pawa Cyber School offers
                                            this website, including all
                                            information, tools and services
                                            available from this site to you, the
                                            user, conditioned upon your
                                          ...
                                          <p>
                                            ...
                                            including without limitation users
                                            who are browsers, vendors,
                                            customers, merchants, and / or
                                            contributors of content.
                                          </p>
                                          <p>
                                            Please read these Terms of Service
                                            carefully before accessing or using
                                            our website. By accessing or using
                                            any part of the site, you agree to
                                            be bound by these Terms of Service.
                                            If you do not agree to all the terms
                                            and conditions of this agreement,
                                            then you may not access the website
                                            or use any services. If these Terms
                                            of Service are considered an offer,
                                            acceptance is expressly limited to
                                            these Terms of Service.
                                          </p>
                                          <p>
                                            Any new features or tools which are
                                            added to the current online school
                                            shall also be subject to the Terms
                                            of Service. You can review the most
                                            current version of the Terms of
                                            Service at any time on this page. We
                                            reserve the right to update, change
                                            or replace any part of these Terms
                                            of Service by posting updates and /
                                            or changes to our website. It is
                                            your responsibility to check this
                                            page periodically for changes. Your
                                            continued use of or access to the
                                            website following the posting of any
                                          ...
                                          <p>
                                            ...
                                            Service, you represent that you are
                                            at least the age of majority in your
                                            state or province of residence, or
                                            that you are the age of majority in
                                            your state or province of residence
                                            and you have given us your consent
                                            to allow any of your minor
                                            dependents to use this site. You may
                                            not use our products for any illegal
                                            or unauthorized purpose nor may you,
                                            in the use of the Service, violate
                                          ...
                                          <p>
                                            ...
                                            viruses or any code of a destructive
                                            nature. A breach or violation of any
                                            of the Terms will result in an
                                          ...
                                          <p>
                                            ...
                                            any time. You understand that your
                                            content (not including credit card
                                            ...
                                            Credit card information is always
                                            encrypted during transfer over
                                            networks.
                                          </p>
                                          <p>
                                            You agree not to reproduce,
                                            duplicate, copy, sell, resell or
                                            exploit any portion of the Service,
                                            use of the Service, or access to the
                                            Service or any contact on the
                                            website through which the service is
                                            provided, without express written
                                            permission by us. The headings used
                                            in this agreement are included for
                                            convenience only and will not limit
                                            or otherwise affect these Terms.
                                          </p>
                                          <h6>Your Fees</h6>
                                          <p>
                                            We will provide the Service to you
                                            on a pre-paid basis. In order to
                                            have continued access to the Service
                                            you must make, and we must receive,
                                            payment of your Fees in advance on
                                            or before the Monthly Due Date. If
                                            we do not receive payment of on or
                                            before due date, we will suspend
                                            your access to the Service. If your
                                            access to the Service is suspended,
                                            we will not reactivate your access
                                            to the Service until we have
                                          ...
                                          <p>
                                            ...
                                            notice. We reserve the right at any
                                            time to modify or discontinue the
                                          ...
                                          <p>
                                            ...
                                            colours and images of our products
                                            that appear at the online school. We
                                            cannot guarantee that your computer
                                            monitor’s display of any colour will
                                            be accurate.
                                          </p>
                                          <p>
                                            We reserve the right, but are not
                                            obligated, to limit the sales of our
                                            products or Services to any person,
                                            geographic region or jurisdiction.
                                            We may exercise this right on a
                                            case-by-case basis. We reserve the
                                            right to limit the quantities of any
                                            products or services that we offer.
                                          </p>
                                          <p>
                                            All descriptions of products or
                                            product pricing are subject to
                                            change at any time without notice,
                                            at the sole discretion of us. We
                                            reserve the right to discontinue any
                                            product at any time. Any offer for
                                            any product or service made on this
                                            site is void where prohibited.
                                          </p>
                                          <p>
                                            We do not warrant that the quality
                                            of any products, services,
                                            information, or other material
                                            purchased or obtained by you will
                                            meet your expectations, or that any
                                            errors in the Service will be
                                            corrected.
                                          </p>
                                          ...
                                          <p>
                                            ...
                                            Pawa Cyber School. Pawa Cyber School
                                            has no control over, and assumes no
                                            responsibility for, the content,
                                            privacy policies, or practices of
                                            any third party web sites or
                                            services. You further acknowledge
                                            and agree that Pawa Cyber School
                                            shall not be responsible or liable,
                                            directly or indirectly, for any
                                            damage or loss caused or alleged to
                                            be caused by or in connection with
                                            use of or reliance on any such
                                            content, goods or services available
                                            on or through any such web sites or
                                            service.
                                          </p>
                                          <h6>
                                          ...
                                          <p>
                                            ...
                                            and/or orders that use the same
                                            billing and/or shipping address. In
                                            the event that we make a change to
                                            or cancel an order, we may attempt
                                            to notify you by contacting the
                                            e-mail and/or billing address/phone
                                            number provided at the time the
                                            order was made.
                                          </p>
                                          <p>
                                            ...
                                            complete and accurate purchase and
                                            account information for all
                                            purchases made at our online school.
                                            ...
                                            dates, so that we can complete your
                                          ...
                                          <p>
                                            ...
                                            school is governed by our Privacy
                                            Policy.
                                          </p>
                                          <h6>
                                          ...
                                          <p>
                                            ...
                                            information on our site, in the
                                            Service or education content that
                                            contains typographical errors,
                                            inaccuracies or omissions that may
                                            relate to product descriptions,
                                            pricing, promotions, offers, product
                                            shipping charges, transit times and
                                            availability. We reserve the right
                                            to correct any errors, inaccuracies
                                            or omissions, and to change or
                                            update information or cancel orders
                                            if any information in the Service or
                                            on any related website is inaccurate
                                            at any time without prior notice
                                            (including after you have submitted
                                            your order).
                                          </p>
                                          <p>
                                            We undertake no obligation to
                                            update, amend or clarify information
                                            in the Service, Product or on any
                                            related website, including without
                                            limitation, pricing information,
                                            except as required by law.
                                          </p>
                                          <p>
                                            No specified update or refresh date
                                            applied in the Service or on any
                                            related website, should be taken to
                                            indicate that all information in the
                                            Service or on any related website
                                          ...
                                          <p>
                                            ...
                                            warrant that your use of our service
                                            will be uninterrupted, timely,
                                            secure or error-free.
                                          </p>
                                          <p>
                                            We do not warrant that the results
                                            that may be obtained from the use of
                                            the service will be accurate or
                                            reliable.
                                          </p>
                                          <p>
                                            You agree that from time to time we
                                            may remove the service for
                                            indefinite periods of time or cancel
                                            the service at any time, without
                                            notice to you.
                                          </p>
                                          <p>
                                            You expressly agree that your use
                                            of, or inability to use, the service
                                            is at your sole risk. The service
                                            and all products and services
                                            delivered to you through the service
                                            are (except as expressly stated by
                                            us) provided ‘as is’ and ‘as
                                            ...
                                            purpose, durability, title, and
                                            noninfringement.
                                          </p>
                                          <p>
                                            In no case shall Pawa Cyber School
                                            our directors, officers, employees,
                                            affiliates, agents, contractors,
                                            interns, suppliers, service
                                            providers or licensors be liable for
                                            any injury, loss, claim, or any
                                            direct, indirect, incidental,
                                            punitive, special, or consequential
                                            damages of any kind, including,
                                            without limitation lost profits,
                                            lost revenue, lost savings, loss of
                                            data, replacement costs, or any
                                            similar damages, whether based in
                                            contract, tort (including
                                            negligence), strict liability or
                                            otherwise, arising from your use of
                                            any of the service or any products
                                            procured using the service, or for
                                            any other claim related in any way
                                            to your use of the service or any
                                            product, including, but not limited
                                            to, any errors or omissions in any
                                            content, or any loss or damage of
                                            any kind incurred as a result of the
                                            use of the service or any content
                                            (or product) posted, transmitted, or
                                            otherwise made available via the
                                            service, even if advised of their
                                            possibility.
                                          </p>
                                          <p>
                                            ...
                                            in such states or jurisdictions, our
                                          ...
                                          <p>
                                            ...
                                            process; exceptions to this policy
                                            are not offered.
                                          </p>
                                          ...
                                          <p>
                                            ...
                                            and you in relation to your use of
                                          ...
                                          <p>
                                            ...
                                            laws of the State of Namibia, and
                                            you submit to the non-exclusive
                                            jurisdiction of the state and
                                            federal courts located in Namibia
                                        ...
                                        <div id="privacy-notice">
                                          ...
                                          <p>
                                            ...
                                            "our") operates
                                            http://www.pawacyberschool.net (the
                                            "Site"). This page informs you of
                                          ...
                                          <p>
                                            ...
                                            with this Privacy Policy, you may
                                            not use our services. Your continued
                                            use of the services following the
                                            posting.
                                          </p>
                                          <h6>
                                          ...
                                          <p>
                                            ...
                                            collects and receives certain
                                            information from your computer or
                                            mobile device, including the
                                            activities you perform on our
                                            Website, the Platforms, and the
                                            Applications, the type of hardware
                                            and software you are using (for
                                            example, your operating system or
                                            browser), and information obtained
                                            from cookies. For example, each time
                                            you visit the Website or otherwise
                                            use the Services, we automatically
                                            collect your IP address, browser and
                                            device type, access times, the web
                                            page from which you came, the
                                            regions from which you navigate the
                                          ...
                                          <ol>
                                            ...
                                            <li>
                                              Other optional information as part
                                            ...
                                            <li>
                                              ...
                                              purchases through the Services, we
                                              may also collect your credit card
                                              or PayPal information
                                            </li>
                                            <li>
                                              Images or other files that you may
                                              publish via our Services
                                            </li>
                                            <li>
                                              Information (such as messages,
                                              posts, comments, pages, profiles,
                                              images) we may receive relating to
                                              communications you send us, such
                                              as queries or comments concerning.
                                            </li>
                                          </ol>
                                          ...
                                          <p>
                                            ...
                                            on most commercial and other
                                            websites. Cookies are small text
                                            written to your computer. They make
                                            our Website easier for you to use
                                            because they save your preferences
                                            while you’re at our sites (although
                                            we do not save passwords in
                                            cookies). Cookies also help us know
                                            which areas are your favourites,
                                            which may need improvement and what
                                            technologies and Internet services
                                            our Users like. Knowing this
                                            information helps us improve the
                                            services for our Users.
                                          </p>
                                          <p>
                                            The information we track with
                                            cookies is anonymous and is not used
                                            to identify, or lead us back to, any
                                            particular User. Users may have the
                                            option of disabling cookies via
                                            their browser preferences (most
                                            browsers are initially set up to
                                            accept cookies). However, some
                                            features of our Website will not
                                            function properly or may function
                                            more slowly if you refuse cookies.
                                            While using our Website, you may get
                                            cookies from our advertisers or
                                            sponsors. We do not control such
                                            cookies. However, such use of
                                            cookies is very common in the
                                            Internet industry.
                                          </p>
                                          <h6>General Compliance With Laws</h6>
                                          <p>
                                            The safety of children is our
                                            highest priority. We comply with
                                            applicable laws and regulations. We
                                            will only use information collected
                                            for educational purposes as it
                                            relates to our services and WILL
                                            NOT:
                                          </p>
                                          <ol>
                                            <li>
                                              ...
                                              notification and consent which
                                              will include an opportunity for
                                              the parent to prevent use of the
                                              information and the child’s
                                              participation in the related
                                              activity. Without prior parental
                                              consent, online information will
                                              only be used to respond directly
                                              to a child’s request and will not
                                            ...
                                            <li>
                                              Distribute to third parties any
                                            ...
                                            <li>
                                              ...
                                              publicly post or otherwise
                                              distribute personally identifiable
                                              contact information without prior
                                              parental consent.{" "}
                                            </li>
                                            <li>
                                              Entice any student by the prospect
                                              of a special game, prize or other
                                              activity to divulge more
                                          ...
                                          <p>
                                            ...
                                            is of the highest priority. We
                                            exercise great care in providing
                                            secure transmission of your
                                            information from your PC to our
                                            servers. Unfortunately, no data
                                            transmission over the Internet can
                                            be guaranteed to be 100% secure. As
                                            a result, while we strive to protect
                                            your personal information, we cannot
                                            ensure or warrant the security of
                                            any information you transmit to us
                                            or through our services, and you do
                                            so at your own risk. Once we receive
                                            your transmission, we make our best
                                            effort to ensure its security on our
                                            systems.
                                          </p>
                                          <p>
                                            Whenever credit card information is
                                            transmitted we use industry
                                            standard, SSL (secure socket layer)
                                            encryption. If you have an account
                                            or use another passwordprotected
                                            service, you are the only person who
                                            can access it and view the User
                                            information concerning the account.
                                            We strongly recommend that you do
                                            not share your password with anyone.
                                            We will never ask you for your
                                            password in an unsolicited phone
                                            call or email.
                                          </p>
                                          <p>
                                            Ultimately, you are responsible for
                                            maintaining the secrecy of your
                                            passwords and any account
                                            information. Please remember to sign
                                            out properly and close your browser
                                            window when you have finished your
                                            work. This helps ensure that others
                                            cannot access your personal
                                            information and in the event the
                                            computer you use is accessible to
                                            others or if you share a computer
                                            with someone else or use a computer
                                            in a public place such as a library
                                            or Internet cafe.{" "}
                                          </p>
                                          <p>
                                            In addition, from time to time we
                                            may create and supply, at our sole
                                            discretion, additional security
                                            features for our Users. These
                                            security features are designed only
                                            for the use of Users. We provide no
                                            warranty, express or implied that
                                            any such security features may not
                                            be broken, violated or in some way
                                            compromised.
                                          </p>
                                          <h6>
                                          ...
                                          <p>
                                            ...
                                            of and will remain in effect except
                                            with respect to any changes in its
                                            provisions in the future, which will
                                          ...
                                          <p>
                                            If we make any material changes to
                                            this Privacy Policy, we will notify
                                            you either through the email address
                                            you have provided us, or by placing
                    ...
                    <div className="col s12 m10">
                      <div className="ex-basic-1">
                        <h4>
                          Please add the subjects you are qualified to teach
                        </h4>
                      </div>
                      <form
                        id="contact"

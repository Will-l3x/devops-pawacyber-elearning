                                ...
                                <div className="col s12 m5">
                                    <div className="row mt-1" >
                                        <div className="form-group">
                                            <p style={{ marginTop: "100px", color: "red", textAlign: 'center', fontSize: '20px' }}>Payment Canceled. Retry Registration</p>

                                            <Link className="btn-solid-lg" rel="noopener noreferrer" to="/register" style={{ marginLeft: "35%", marginTop: "100px", marginRight: "35%" }}>
                                                 Register Now
                                             </Link>

...
const Main = ({ store }) => (
  <Switch store={store}>
    ...
    <Route exact path="/teacher-management" component={AdminTeacherManagementScreen} />
    ...
    <Route exact path="/classroom-mark" component={TeacherMarkClassroomScreen} />
    <Route exact path="/classroom-mark-test" component={StudentTestScreen} />
    <Route exact path="/classroom-mark-assignment" component={StudentAssignmentScreen} />

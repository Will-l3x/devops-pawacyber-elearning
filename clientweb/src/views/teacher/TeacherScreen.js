      ...
      <div className="wrapper">
        <aside id="left-sidebar-nav">
          ...
          <Link
            ...
            className="sidebar-collapse waves-effect sidenav-trigger waves-block waves-light hide-on-large-only"
          >
        ...
        <section id="content">
          <div className="container">
            <div id="card-widgets" style={{marginTop: '20px'}}>
              <div className="row">

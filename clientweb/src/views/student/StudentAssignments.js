                      ...
                      <li className={`collection-header teal `}>
                        ...
                        <li className="collection-item dismissable">
                          <label htmlFor="task1">
                            Pending Assignments
                            <Link to="#"
                              onClick={() => this.selectCategory('Pending Assignments', 'Pending')}
                        ...
                        <li className="collection-item dismissable">
                          <label htmlFor="task1">
                            ...
                            <Link to="#" onClick={() => this.selectCategory('Submitted Assignments', 'Submitted')} className="secondary-content">
                              <span className="ultra-small">VIEW</span>
                            </Link>
                          </label>
                        </li>                     
                        <li className="collection-item dismissable">
                          <label htmlFor="task1">
                           Submit New Assignment
                            <Link to="#" onClick={() => this.selectCategory('Submit New Assignment', 'Pending')} className="secondary-content">
                  ...
                  <div className="col s12 m13 l9">
                    <div className="task-card collection with-header">
                      <div className="collection-header teal">
                        <p className="task-card-title" style={{ color: "white" }} >
                                          ...
                                          <div  className="card min-height-100 white-text designed-dots" style={{borderRadius:"5px"}}>
                                              <div className="padding-4">
                                                  <div className="col s12 m12">
                                                      <p className="no-margin" style={{color:"teal",}}><b>{assigment.assignmentTitle}</b></p>
                                                      <p className = "no-margin" style={{fontSize:"12px", color:"grey"}}>{assigment.date}</p>
                                                      <p className={assigment.assignmentStatus==="Pending"?"red":"gradient-45deg-light-blue-cyan"} style={{paddingLeft:"5px"}}>{assigment.score!==""?`Graded: ${assigment.score}`:`${assigment.assignmentStatus}`}</p>
                                                  </div>
                                                  <div className="right-align" style={{marginTop:"70px",color:"black"}}>
                                          ...
                                          <div  key={i} className="col s12 m8 l4">  
                                            <div className="card min-height-100 white-text designed-dots" style={{borderRadius:"5px"}}>
                                                <div className="padding-4">
                                                    ...
                                                    <div className="right-align" style={{marginTop:"70px",color:"black"}}>
                                        <p className="no-margin">{this.assignmentCategory==="Submit New Assignment"?"UPLOAD":"DOWNLOAD"}</p>
                                                    </div> 
                                                </div>
                                            </div>
                                          </div>

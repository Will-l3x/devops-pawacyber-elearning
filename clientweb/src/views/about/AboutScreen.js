...
export class AboutScreen extends Component {
    render() {
        ...
        <div className="ex-basic-2" style={{marginLeft:"70px",marginRight:"70px"}}>
        ...
        <div className="container">
            <div className="row mt-1">
                    ...
                    <div className="text-container">
                        ...
                        <p>PawaCyber School eLearning also automatically collects and receives certain information from your computer or mobile device, including the activities you perform on our Website, the Platforms, and the Applications, the type of hardware and software you are using (for example, your operating system or browser), and information obtained from cookies. For example, each time you visit the Website or otherwise use the Services, we automatically collect your IP address, browser and device type, access times, the web page from which you came, the regions from which you navigate the web page, and the web page(s) you access (as applicable).</p>
                        <p>When you first register for a PawaCyber School eLearning account, and when you use the Services, we collect some <a className="turquoise" href="#">Personal Information</a> about you such as:</p>
                        <div className="row mt-1">
            ...
            <div class="row  mt-1">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li><i class="fas fa-phone"></i><a class="turquoise" href="tel:+263785302628">+263 78 530 2628</a></li>
                        <li><i class="fas fa-envelope"></i><a class="turquoise" href="mailto:keptac/flutter@gmail.com">email@email.com</a></li>
                    </ul>
                </div> 
            </div> 
            <div class="row mt-1">
                <div class="col s12 m6">
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d486204.0276277509!2d31.0568583!3d-17.8166376!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1931a4ee1bdddb35%3A0xa5143b9be5134f2f!2sHarare!5e0!3m2!1sen!2szw!4v1589938207271!5m2!1sen!2szw" allowfullscreen></iframe>
                    </div>
                </div> 
                <div class="col s12 m6">                    

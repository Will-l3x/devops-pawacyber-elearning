...
let checkToken = (req, res, next) => {
    ...
    if (req.url !== '/api/login' && req.url !== '/api/register' && req.url !=='/api/multi_upload' && req.url !== '/api/resetpassword' && req.url.indexOf('/api/verify') < 0 && req.url !== '/api/refreshotp') {
...
module.exports = {
    ...
    register: register,
    login:login
>>>>>>> 3d8d6cd936faa0cd6d5ded8b6107daa89dc83043
};